...
set_property IOSTANDARD LVCMOS33 [get_ports vp_in_0]
set_property IOSTANDARD LVCMOS33 [get_ports vn_in_1]
set_property IOSTANDARD LVCMOS33 [get_ports vauxp0_0]
set_property IOSTANDARD LVCMOS33 [get_ports vauxn0_0]
set_property IOSTANDARD LVCMOS33 [get_ports vauxp1_0]
set_property IOSTANDARD LVCMOS33 [get_ports vauxn1_0]
set_property IOSTANDARD LVCMOS33 [get_ports vauxp8_0]
set_property IOSTANDARD LVCMOS33 [get_ports vauxn8_0]
set_property IOSTANDARD LVCMOS33 [get_ports vauxp9_0]
set_property IOSTANDARD LVCMOS33 [get_ports vauxn9_0]

set_property PACKAGE_PIN K9  [get_ports vp_in_0]
set_property PACKAGE_PIN L10 [get_ports vn_in_1]
set_property PACKAGE_PIN C20 [get_ports vauxp0_0]
set_property PACKAGE_PIN B20 [get_ports vauxn0_0]
set_property PACKAGE_PIN E17 [get_ports vauxp1_0]
set_property PACKAGE_PIN D18 [get_ports vauxn1_0]
set_property PACKAGE_PIN B19 [get_ports vauxp8_0]
set_property PACKAGE_PIN A20 [get_ports vauxn8_0]
set_property PACKAGE_PIN E18 [get_ports vauxp9_0]
set_property PACKAGE_PIN E19 [get_ports vauxn9_0]
