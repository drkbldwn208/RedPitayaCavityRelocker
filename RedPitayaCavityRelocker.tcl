...
#
# RedPitayaCavityRelocker.tcl: Tcl script for re-creating project 'RedPitayaCavityRelocker'
#
# Generated by Vivado on Fri Apr 03 01:54:00 PDT 2026
...
#
# 1. This project restoration tcl script (RedPitayaCavityRelocker.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/levlabcukomen/Desktop/VivadoProjects/RedPitayaCavityRelocker/RedPitayaCavityRelocker.srcs/sources_1/new/axis_red_pitaya_adc.v"
#    "/home/levlabcukomen/Desktop/VivadoProjects/RedPitayaCavityRelocker/RedPitayaCavityRelocker.srcs/sources_1/new/axis_red_pitaya_dac.v"
#    "/home/levlabcukomen/Desktop/VivadoProjects/RedPitayaCavityRelocker/RedPitayaCavityRelocker.srcs/sources_1/new/axi_hub.v"
#    "/home/levlabcukomen/Desktop/VivadoProjects/RedPitayaCavityRelocker/RedPitayaCavityRelocker.srcs/constrs_1/new/constraints.xdc"
#    "/home/levlabcukomen/Desktop/VivadoProjects/RedPitayaCavityRelocker/RedPitayaCavityRelocker.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/RedPitayaCavityRelocker.srcs/sources_1/new/axis_red_pitaya_adc.v"]"\
 "[file normalize "$origin_dir/RedPitayaCavityRelocker.srcs/sources_1/new/axis_red_pitaya_dac.v"]"\
 "[file normalize "$origin_dir/RedPitayaCavityRelocker.srcs/sources_1/new/axi_hub.v"]"\
 "[file normalize "$origin_dir/RedPitayaCavityRelocker.srcs/constrs_1/new/constraints.xdc"]"\
 "[file normalize "$origin_dir/RedPitayaCavityRelocker.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../VitisProjects/CavityRelock/hls_cavity_relock/hls_cavity_relock/hls/impl/ip"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "RedPitayaCavityRelocker"
...
set script_file "RedPitayaCavityRelocker.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../VitisProjects/CavityRelock/hls_cavity_relock/hls_cavity_relock/hls/impl/ip"]" $obj
...
set file "new/axis_red_pitaya_adc.v"
...
set file "new/axis_red_pitaya_dac.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "[file normalize "$origin_dir/RedPitayaCavityRelocker.srcs/constrs_1/new/constraints.xdc"]"
...
set_property -name "top" -value "axi_hub" -objects $obj
...
if { [get_files [list axis_red_pitaya_adc.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/levlabcukomen/Desktop/VivadoProjects/RedPitayaCavityRelocker/RedPitayaCavityRelocker.srcs/sources_1/new/axis_red_pitaya_adc.v
}
if { [get_files [list axis_red_pitaya_dac.v]] == "" } {
  import_files -quiet -fileset sources_1 /home/levlabcukomen/Desktop/VivadoProjects/RedPitayaCavityRelocker/RedPitayaCavityRelocker.srcs/sources_1/new/axis_red_pitaya_dac.v
}
...
# axis_red_pitaya_adc, axis_red_pitaya_dac
  ...
  connect_bd_intf_net -intf_net cavity_relocker_0_dac_out [get_bd_intf_pins cavity_relocker_0/dac_out] [get_bd_intf_pins axis_red_pitaya_dac_0/s_axis]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins axis_red_pitaya_adc_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins axis_red_pitaya_dac_0/aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins cavity_relocker_0/ap_clk]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.609815",
   "Default View_TopLeft":"-533,-735",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1610 -y -470 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1610 -y -450 -defaultsOSRD
preplace port port-id_adc_enc_p_o -pg 1 -lvl 6 -x 1610 -y -550 -defaultsOSRD
preplace port port-id_adc_clk_n_i -pg 1 -lvl 0 -x -310 -y -80 -defaultsOSRD
preplace port port-id_adc_enc_n_o -pg 1 -lvl 6 -x 1610 -y -530 -defaultsOSRD
preplace port port-id_adc_csn_o -pg 1 -lvl 6 -x 1610 -y -510 -defaultsOSRD
preplace port port-id_adc_clk_p_i -pg 1 -lvl 0 -x -310 -y -510 -defaultsOSRD
preplace port port-id_dac_clk_o -pg 1 -lvl 6 -x 1610 -y 10 -defaultsOSRD
preplace port port-id_dac_rst_o -pg 1 -lvl 6 -x 1610 -y -610 -defaultsOSRD
preplace port port-id_dac_sel_o -pg 1 -lvl 6 -x 1610 -y -590 -defaultsOSRD
preplace port port-id_dac_wrt_o -pg 1 -lvl 6 -x 1610 -y -570 -defaultsOSRD
preplace portBus adc_dat_a_i -pg 1 -lvl 0 -x -310 -y -550 -defaultsOSRD
preplace portBus adc_dat_b_i -pg 1 -lvl 0 -x -310 -y -530 -defaultsOSRD
preplace portBus dac_dat_o -pg 1 -lvl 6 -x 1610 -y 80 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 4 -x 930 -y -580 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 3 -x 470 -y -300 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x -160 -y 10 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 2 -x 150 -y -370 -defaultsOSRD
preplace inst axis_red_pitaya_adc_0 -pg 1 -lvl 3 -x 470 -y -20 -defaultsOSRD
preplace inst axis_red_pitaya_dac_0 -pg 1 -lvl 5 -x 1370 -y 40 -defaultsOSRD
preplace inst cavity_relocker_0 -pg 1 -lvl 4 -x 930 -y 0 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 5 -x 1370 -y -1250 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -x 1370 -y -990 -defaultsOSRD
preplace netloc adc_clk_n_i_1 1 0 1 -290 -80n
preplace netloc adc_clk_p_i_1 1 0 1 -280 -510n
preplace netloc adc_dat_a_i_1 1 0 3 NJ -550 NJ -550 270
preplace netloc adc_dat_b_i_1 1 0 3 NJ -530 NJ -530 230
preplace netloc axis_red_pitaya_adc_0_adc_csn 1 3 3 680J -210 N -210 1570
preplace netloc axis_red_pitaya_dac_0_dac_clk 1 5 1 1550 0n
preplace netloc axis_red_pitaya_dac_0_dac_dat 1 5 1 N 80
preplace netloc axis_red_pitaya_dac_0_dac_rst 1 5 1 1540 -610n
preplace netloc axis_red_pitaya_dac_0_dac_sel 1 5 1 1560 -590n
preplace netloc axis_red_pitaya_dac_0_dac_wrt 1 5 1 1580 -570n
preplace netloc clk_wiz_0_clk_out1 1 1 4 N -20 260J -120 700 -680 1210
preplace netloc clk_wiz_0_clk_out2 1 1 4 -40J -110 NJ -110 NJ -110 1180
preplace netloc clk_wiz_0_clk_out3 1 1 4 -30 -100 NJ -100 NJ -100 1150J
preplace netloc clk_wiz_0_locked 1 1 4 N 40 280J 90 N 90 1200
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 3 2 670 -930 1200
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 3 290 -200 NJ -200 1150
preplace netloc axi_mem_intercon_M00_AXI 1 3 3 710 -1110 NJ -1110 1520
preplace netloc axis_red_pitaya_adc_0_m_axis 1 3 1 690 -30n
preplace netloc cavity_relocker_0_dac_out 1 4 1 1170 -20n
preplace netloc cavity_relocker_0_m_axi_gmem 1 4 1 1160 -1050n
preplace netloc processing_system7_0_DDR 1 4 2 1220 -470 N
preplace netloc processing_system7_0_FIXED_IO 1 4 2 1180 -450 N
preplace netloc processing_system7_0_M_AXI_GP0 1 4 1 1150 -1310n
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 3 710 -190 NJ -190 1530
levelinfo -pg 1 -310 -160 150 470 930 1370 1610
pagesize -pg 1 -db -bbox -sgen -490 -1370 1780 240
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/RedPitayaCavityRelocker.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
